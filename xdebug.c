...
PHP_INI_BEGIN()
	...
	STD_PHP_INI_BOOLEAN("xdebug.remote_resolve_breakpoints","1",        PHP_INI_ALL,    OnUpdateBool,   settings.debugger.remote_resolve_breakpoints,  zend_xdebug_globals, xdebug_globals)
